...
m = Map("qos_gargoyle", translate("Active Congestion Control"),
    translate("Active Congestion Control dynamically adjusts bandwidth limits based on real-time network latency to maintain low-latency network connections.<br><strong style='color: red;'>Note: Enabling ACC may require reducing total bandwidth.</strong>"))
...
algo_desc.cfgvalue = function()
    return "<div style=\"padding: 10px; background: #f5f5f5; border-radius: 5px; margin-top: 10px;\">" ..
           "<strong>" .. translate("Optimized Algorithm Description:") .. "</strong>" ..
           "<ul style=\"margin: 5px 0; padding-left: 20px;\">" ..
           "<li>" .. translate("Adaptive Control: Adjusts bandwidth based on latency; increases bandwidth when ping is below limit, decreases when above limit.") .. "</li>" ..
           "<li>" .. translate("Real-time Class Detection: Automatically detects real-time/MinRTT classes in TC and adjusts strategy accordingly.") .. "</li>" ..
           "<li>" .. translate("State Machine: Includes CHK, INIT, ACTIVE, REALTIME, IDLE states, automatically switching based on network conditions.") .. "</li>" ..
           "<li>" .. translate("Filter: Uses exponential smoothing to filter ping times and bandwidth data, avoiding jitter.") .. "</li>" ..
           "</ul>" ..
           "<small style=\"color: #666;\">" .. translate("Default parameters are optimized for most networks; no adjustment needed.") .. "</small>" ..
           "</div>"
end
...
adv_desc.cfgvalue = function()
    return "<div style=\"padding: 10px; background: #f5f5f5; border-radius: 5px; margin-top: 10px;\">" ..
           "<strong>" .. translate("Internal Parameters Description:") .. "</strong>" ..
           "<ul style=\"margin: 5px 0; padding-left: 20px;\">" ..
           "<li>" .. translate("These parameters affect the internal behavior of the algorithm and usually do not need modification.") .. "</li>" ..
           "<li>" .. translate("Modifying internal parameters requires restarting the qosacc service to take effect.") .. "</li>" ..
           "<li>" .. translate("It is recommended for experienced users to adjust according to specific network environment.") .. "</li>" ..
           "</ul>" ..
           "</div>"
end
